...
<div style="position: relative; overflow: hidden; padding: 2rem 1.45rem 2.15rem; border: 1px solid var(--lightgray); border-radius: 24px; background: linear-gradient(135deg, rgba(132, 165, 157, .16), rgba(255, 178, 102, .12)); margin: 1rem 0 1.8rem; box-shadow: 0 18px 45px rgba(40, 75, 99, .08);">
  <div style="font-family: 'Schibsted Grotesk', 'Avenir Next', 'Helvetica Neue', sans-serif; font-size: 2rem; line-height: 1; margin-bottom: .8rem; letter-spacing: .01em;">🍊 Latent Atlas 🍉</div>
  ...
  <h1 style="font-family: KaiTi, STKaiti, serif; font-size: 2rem; line-height: 1.18; margin: 0 0 .9rem; font-weight: 700;">一座面向大模型全栈的潜在知识地图</h1>
  <p style="font-family: KaiTi, STKaiti, serif; font-size: 1.16rem; line-height: 1.85; margin: 0; color: var(--darkgray); max-width: 50rem;">在这里，论文、源码、实验和工程经验会逐渐生长成一张可检索、可链接、可复用的大模型全栈知识地图。</p>
</div>
