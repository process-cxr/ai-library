  ...
  return (
    <>
      ...
      >
        ...
        <span class="readermode-label readermode-label-off">Hide sidebars</span>
        <span class="readermode-label readermode-label-on">Show sidebars</span>
      </button>
      {fileData.toc && (
        <nav class={classNames(displayClass, "reader-toc")} aria-label="Reader table of contents">
